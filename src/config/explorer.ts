...
export const getTransactionUrl = (hash: string, chainId: SupportedChainId = SUPPORTED_CHAINS.BASE_SEPOLIA): string => {
...
export const getAddressUrl = (address: string, chainId: SupportedChainId = SUPPORTED_CHAINS.BASE_SEPOLIA): string => {
  const config = EXPLORER_CONFIGS[chainId];
  if (!config) return '';
...
export const getTokenUrl = (address: string, chainId: SupportedChainId = SUPPORTED_CHAINS.BASE_SEPOLIA): string => {
  const config = EXPLORER_CONFIGS[chainId];
  if (!config) return '';
...
// Get explorer config
export const getExplorerConfig = (chainId: SupportedChainId = SUPPORTED_CHAINS.BASE_SEPOLIA) => {
